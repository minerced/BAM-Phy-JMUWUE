...
o_Stoppuhr=math.sqrt(2)*0.2 #Messfehler der Stoppuhr in s
...
m_ges_max=0 #Gasamtmasse bei Maximaler Zeit bzw. Auslenkung
...
o_m_ges=o_Waage #fehler der Gesamtmasse der statischen Methode
D_stat_rech=m_ges_max*g/x_max_stat #Bestwert der Federhärte D Rechnersich bestimmt (Fehler da nicht ruhe Lage berücksichtigt)
o_D_stat_rech=math.sqrt((o_m_ges/m_ges_max)**2 + (o_Messleiste/x_max_stat)**2)*D_stat_rech #Fehler der Federhärte D rechnerisch bestimmt
...
D_dym_rech=4*(math.pi**2)*m_ges_max/(T_f**2) #Bestwert der Federhärte Rechnerisch bestimmt für dynamische Methode
o_D_dym_rech=math.sqrt((o_m_ges/m_ges_max)**2+4*(o_T_f/T_f)**2)*D_dym_rech #Fehler der Federhärte Rechnerisch bestimmt für dynamische Methode
